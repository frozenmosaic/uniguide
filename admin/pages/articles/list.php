...
<table cellpadding="0" cellspacing="0" border="0" class="tbl_repeat">
	...
	<tr>
		...
		<td class="ta_r"><a href="/start/admin/?page=articles&amp;action=remove&amp;id=<?php echo $article['id'];?>">Remove</a></td>
		<td class="ta_r"><a href="/start/admin?page=articles&amp;action=edit&amp;id=<?php echo $article['id'];?>">Edit</a></td>
	</tr>
