...
<form action="" method="post" id="source" data-url="<?php echo root() . '/' . 'admin/scraping/master-scraping.php';?>">
    <table cellpadding="0" cellspacing="0" border="0" class="tbl_insert">
        
        <tr>
            <th><label for="usn">US News: *</label></th>
            <td><?php echo $objValid->validate('src'); ?>
        ...
        <tr>
            ...
            <input type="text" name="cb_glance" id="cb_glance" value="<?php echo $objForm->stickyText('cb_glance');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input type="text" name="cb_app" id="cb_app" value="<?php echo $objForm->stickyText('cb_app');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input name="cb_sat_cr" id="cb_sat_cr" value="<?php echo $objForm->stickyText('cb_sat_cr');?>" class="fld"></td>
        </tr>
        ...
        <tr>
            ...
            <input  name="cb_sat_m" id="cb_sat_m" value="<?php echo $objForm->stickyText('cb_sat_m');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input  name="cb_sat_wr" id="cb_sat_wr" value="<?php echo $objForm->stickyText('cb_sat_wr');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input  name="pop_majors" id="pop_majors" value="<?php echo $objForm->stickyText('pop_majors');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input  name="majors" id="majors" value="<?php echo $objForm->stickyText('majors');?>" class="fld"   cols="70"/></td>
        </tr>
        ...
        <tr>
            ...
            <input  name="intl" id="intl" value="<?php echo $objForm->stickyText('intl');?>" class="fld"   cols="70"/></td>
        </tr>
